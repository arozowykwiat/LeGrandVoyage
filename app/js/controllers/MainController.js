...
var poemeGrec=[
	{
		idPoeme:1,
		idStrophe:1,
		strophe:"<p>… θα διαβαστεί σ’ ένα μέλλον που ίσως<br>δεν υπάρξει ποτέ. Γλιστρά στον αφρό<br/>παγετώνων που λιώνουν· ό,τι γράφεις<br/>ανήκει σ’ ένα παρελθόν που έμοιαζε<br/>πάντα, απ’ τον καιρό του φιδιού, αθώο.</p>"
	},
	{
		idPoeme:1,
		idStrophe:2,
		strophe:"<p>Άδειο χέρι σε πλήκτρα δίχως ήχο,<br>βλέμμα κενό στην οθόνη νοσταλγεί<br/>το πιάνο, που συγκινεί τη χορδή.<br/>Όχι, το ηλεκτρικό κλαβιέ διαφέρει:<br/>μία τουλάχιστον αλήθεια ας δεχτείς.</strong></p>"
	},
	{
		idPoeme:1,
		idStrophe:3,
		strophe:"<p>Πώς έφτασε έτσι ραγδαία η ώρα,<br/>ένας ρυθμός αντ’ άλλου αδιακρίτως<br/>να χτυπά, μια φράση αντ’ άλλης· δάχτυλα<br/>δίχως κάλους να γράφουν μουσική σαν<br/>ξένη ανάμνηση κι η φράση να φεύγει</p>"
	},	
	{
		idPoeme:1,
		idStrophe:4,
		strophe:"<p>τις έννοιες σ’ έναν άναρθρο καιρό<br/>συνωνύμων. Έφτασ’ έτσι ραγδαία<br/>του δικτάτορα η ώρα στην ψυχή<br/>καθενός: δεν κυβερνά με τη βία,<br/>συγχέει εγωισμό κι αυτογνωσία,/p>"
	},
	{
		idPoeme:1,
		idStrophe:5,
		strophe:"<p>εξωραΐζει την αλαζονεία,<br/>πίνει πετρέλαιο αντί για νερό.<br/>Ό,τι γράφεις την ώρα που θάρρεψε<br/>πως γνωρίζει αρκετά και σκοτώνει<br/>το δάσκαλο, την ώρα που αγνοεί</p>"
	},	
	{
		idPoeme:1,
		idStrophe:6,
		strophe:"<pτης ανάγκης την άσκηση, αδρανεί<br/>την ψυχή κι αποβάλλει το πάθος,<br/>ανήκει σ’ έναν καιρό δίχως αύριο.</p>"
	},	
	{
		idPoeme:1,
		idStrophe:7,
		strophe:"<p>Μα ο χρόνος επιτρέπει στον άνθρωπο<br/>να νιώθει τι συμβαίνει άλλοτε κι αλλού.</p>"
	},	
	{
		idPoeme:2,
		idStrophe:1,
		partie:"I",
		strophe:"<p>Πώς θα σαλπάρει τούτο το καράβι,<br/>καθώς το δέσαν έτσι στο γιαλό; Πού<br/>θα τραβήξει σαν έχουν οι ανέμοι<br/>παραλύσει; Bαρύς καιρός σιμώνει<br/>και σαν νυχτώνει, βρεμένη η κουπαστή.</p>"
	},
	{
		idPoeme:2,
		idStrophe:2,
		strophe:"<p>Mα το πανί κανείς δεν το μπαλώνει<br/>κι ας τώχει άγρια δείρει ο χαλασμός.<br/>Xίλιες φορές σου τώπα, καπετάνιε,<br/>μέτρα να λάβεις, να ανασκουμπωθείς.<br/>Δικό σου είναι το σκαρί που μόνο</p>"
	},
	{
		idPoeme:2,
		idStrophe:3,
		strophe:"<p>σύ μπορείς να κουμαντάρεις. Kι ας είχες<br/>μπάρκο μακρινό σαλπάρει και βαρύ,<br/>άλλον δεν ακούει τούτο το σκαρί.<br/>Του παραγγείλαν μυστική αποστολή<br/>και κίνησε μονάχο του να πάει.</p>"
	},
	{
		idPoeme:2,
		idStrophe:4,
		strophe:"<p>Aρμένιζε δίχως ούτ’ ένα ναύτη<br/>κι οι Έριφοι σμίγανε στον ουρανό.<br/>Τόσοι έχασαν έτσι τη ζωή τους<br/>μα ετούτο πήγε κι ήρθε μοναχό.<br/>Kοίταξε, καπετάνιε, σε λιμάνι κοσμικό</p>"
	},
	{
		idPoeme:2,
		idStrophe:5,
		strophe:"<p>να ξεφορτώσεις, στείλε το ακριβό σου μπάρκο<br/>με καραβάνι μακρινό. Mα σύ κόπιασε δώ,<br/>σ’ έρμο γιαλό πούχει το πνεύμα σου στοιχειώσει.<br/>Eσένα περιμένουν μούτσοι και λοστρόμοι,<br/>εσένα κατοικούν και του ανέμου οι δρόμοι</p>"
	},
	{
		idPoeme:2,
		idStrophe:6,
		strophe:"<p>και τα θαλάσσια κήτη σε κοιτούν. Eίναι<br/>καράβι μαγικό, έχει γυρίσει όλη τη γη,<br/>εκεί που συναντά η Δύση την Ανατολή<br/>και του φωτός ανατροπή χάνεται στα σκότη.<br/>Αυτό γνωρίζει τον κρυμμένο θησαυρό.</p>"
	},
	
	{
		idPoeme:2,
		idStrophe:7,
		strophe:"<p>Γοργόνες τον φυλάνε κι έταξαν σκοπό<br/>να σου το πάρουν το μυαλό. Στη θάλασσα<br/>το φάντασμα θα βλέπεις. Kαι τούτο το λαφρύ,<br/>απρόσμενο σκαρί, δίχως σταυρό σε στέλνει.<br/>Δε θ’ ακουστούν για σένα ψαλμωδίες,</p>"
	},	
	{
		idPoeme:2,
		idStrophe:8,
		strophe:"<p>ούτε καμπάνες θ’ αντηχούν, κουρέλια<br/>lμες στα κύματα το σώμα σου θα παραδέρνει.<br/>Γύρισε καπετάνιε στον υγρό γιαλό,<br/>το τάμα πλήρωσε, να σε χαρώ, προτού<br/>τα πέλαγα αξεδιάλυτα σφραγίσει.</p>"
	},
	{
		idPoeme:2,
		idStrophe:9,
		strophe:"<p>Bογγά κρυφά ο θησαυρός<br/>κι είναι στο γύρισμα ο καιρός<br/>προτού αιώνια νυχτώσει.</p>"
	},
	{
		idPoeme:2,
		idStrophe:10,
		partie:"II",
		strophe:"<p>Μ’ αρέσουν οι φιγούρες του θυμωμένου φεγγαριού<br/>καθώς τα σύννεφα φουμάρει. Τα ξωτικά μ’ αρέσουν,<br/>καθώς γλιστρούν επάνω σε οργισμένες ηλιαχτίδες.</p>"
	},
	{
		idPoeme:2,
		idStrophe:11,
		strophe:"<p>Μα όταν ρόδου αγκάθι θανατερό ματώσει,<br/>αλίμονο σ’ όποιον το λόγο του θεού δε νιώσει<br/>από τη γέννηση κι από το τέλος των πραγμάτων.</p>"
	},

	{
		idPoeme:2,
		idStrophe:12,
		strophe:"<p>Μ’ αρέσουνε τα σουφρωμένα φρύδια των τεράτων,<br/>τα δρέπανα που αστραφτοκοπούν θερίζοντας<br/>χρυσαφένιο αγρό: σκληρό λεπίδι καθαρίζει</p>"
	},
	{
		idPoeme:2,
		idStrophe:13,
		strophe:"<p>το σκοτισμένο καρπό των πνευμάτων. Στις ερημιές<br/ολόξερα χορτάρια θ’ απομείνουν να ανασάνουν<br/>οι ψυχές· σαν οπτασία φωτός ξαναπροβάλλουν</p>"
	},
	{
		idPoeme:2,
		idStrophe:14,
		strophe:"<p>πλούσιες και λευκές, παρθενικές, εξαπτέρυγες<br/>μυρωμένες λειτουργίες. Ό,τι έχασες μην κλάψεις,<br/>ό,τι άφησες μη λυπηθείς και ό,τι έλειψε</p>"
	},
	{
		idPoeme:2,
		idStrophe:15,
		strophe:"<p>θα λάβεις, μόνο μην αρνηθείς πικρό όταν κοπεί<br/>στην άνθηση τ’ ολόφρεσκο βλαστάρι, την αλλαγή,<br/>καθώς μεταμορφώνει από την ύλη την ψυχή.</p>"
	},
	{
		idPoeme:2,
		idStrophe:16,
		strophe:"<p>Φύγε με τον άνεμο, φύγε με το κύμα, κι αν πας<br/>lκατακεί που ήρθες, δεν είναι γυρισμός· οι μορφές<br/>είναι που κοινωνούν. Kαι σύ, διάφανη μεμβράνη</p>"
	},
	{
		idPoeme:2,
		idStrophe:17,
	...
	},
	{
		idPoeme:2,
		idStrophe:19,
		strophe:"<p>Eίν’ όργανα της Tύχης, εκτελεστές του χρόνου και<br/>της γης. Όταν σηκώνονται οι άγκυρες βογγώντας,<br/>άσε να κλάψουν στο λιμάνι οι συγγενείς, τα μάτια</p>"
	},	
	{
		idPoeme:2,
		idStrophe:20,
		strophe:"<p>κείνα που βουρκώνουν στην αλμύρα και παγώνουν<br/>εύκολα ξεχνιούνται με τις εικόνες τις πλαστές.<br/>Φύγε με τον άνεμο και με τις βροντές· κοράλλια</p>"
	},
		{
		idPoeme:2,
		idStrophe:21,
		strophe:"<p>πορφυρά, σεντέφια που βρωμούν και ψοφίμι ακόμα<br/>νοσταλγούν να ’γγίξεις, στιλπνό και απαλό, υγρό,<br/>μαύρο μαργαριτάρι του μυστικού βυθού.</p>"
	},	
		{
		idPoeme:2,
		idStrophe:22,
		partie:"III",
		strophe:"<p>Στο λιμάνι θυμάμαι ν’ αγναντεύεις<br/>το μέλλον μας σε θάλασσα αλμυρή.</p>"
	},
		{
		idPoeme:2,
		idStrophe:23,
		strophe:"<p>Αλλ’ όταν μ’ εγκατέλιπες στο μάτι<br/>των ανέμων, άκουγες την κραυγή μου<br/>στα Στροφάδια, που άγιες μόνον εικόνες<br/>από γιαλό σ’ άλλο γιαλό διαβαίνουν.<br/>Τώρα πού θα βρεις του έρωτα φωνή;</p>"
	},	
	{
		idPoeme:2,
		idStrophe:24,
